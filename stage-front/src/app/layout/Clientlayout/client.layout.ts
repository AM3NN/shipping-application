...
import {AppClientSidebar} from "./client-sidebar";


@Component({
    selector: 'app-layout',
    imports: [CommonModule, RouterModule, AppFooter, ClientTopbar,  AppClientSidebar],
...
export class ClientLayout {
    ...
    @ViewChild(AppClientSidebar) appSidebar!: AppClientSidebar;
